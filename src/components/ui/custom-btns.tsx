...
export function GradientBorderBtn({text}: {text: string}) {
    return (
...
export function GradientBorderBtn2({text}: {text: string}) {
    return (
...
export function InvertBtn({ text }: { text: string }) {
    return (
...
export function InvertBtn2({ text }: { text: string }) {
    return (
